...
const updateImportTalentContractStubs = (talent?: Partial<Talent>) =>
  cy.stubGraphQLRequests({
    ...talentProfileStubs({
      ...talent,
      operations: getTalentOperations({
        importTalentContract: enabledOperationMock()
      })
    }),
    GetLazyOperation: {
      data: {
    ...
    ImportTalentContract: {
      data: {
        importTalentContract: successOperationMock()
      }
    }
  })

export default updateImportTalentContractStubs
