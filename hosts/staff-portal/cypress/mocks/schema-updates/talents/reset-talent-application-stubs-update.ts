...
const updateResetTalentApplicationStubs = (talent?: Partial<Talent>) =>
  cy.stubGraphQLRequests({
    ...talentProfileStubs({
      ...talent,
      operations: getTalentOperations({
        resetRejectedTalentApplication: enabledOperationMock()
      })
    }),
    GetLazyOperation: {
      data: {
...
export default updateResetTalentApplicationStubs
