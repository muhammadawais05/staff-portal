...
import { updateScheduleInterviewStubs } from '~integration/mocks/schema-updates/engagement'
import { ScheduleInterview } from '~integration/modules/pages/engagements/components'

describe('Engagement page -> More -> Schedule Interview', () => {
  const page = new Engagement()
  const scheduleInterview = new ScheduleInterview()

  beforeEach(() => {
    updateScheduleInterviewStubs()
  })
