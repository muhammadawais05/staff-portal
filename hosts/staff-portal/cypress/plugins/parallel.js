 ...
 *  CYPRESS_STAFF_PORTAL_CHUNKS_COUNT=3 CYPRESS_CHUNK_ID=1 cypress run ...
 *  CYPRESS_STAFF_PORTAL_CHUNKS_COUNT=3 CYPRESS_CHUNK_ID=2 cypress run ...
 *  CYPRESS_STAFF_PORTAL_CHUNKS_COUNT=3 CYPRESS_CHUNK_ID=3 cypress run ...
 */
module.exports = (on, config) => {
  config.env.chunkId = parseInt(process.env.CYPRESS_CHUNK_ID || '1', 10)
  config.env.chunksCount = parseInt(
    process.env.CYPRESS_STAFF_PORTAL_CHUNKS_COUNT || '1',
    10
  )
