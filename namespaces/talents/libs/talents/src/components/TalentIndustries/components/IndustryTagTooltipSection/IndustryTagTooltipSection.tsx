...
const IndustryTagTooltipSection = ({
  ...
  return (
    <Container
      css={S.section}
      key={name}
      data-testid='industry-tag-tooltip-section'
    >
      <Container flex justifyContent='space-between' alignItems='center'>
        <Typography
          ...
          inline
          color='black'
          data-testid='industry-tag-tooltip-section-name'
        >
          {name}
        </Typography>
        <Container flex alignItems='center'>
          ...
          <Typography
            ...
            inline
            size='xsmall'
            data-testid='industry-tag-tooltip-section-amount'
          >
            {amount}
          </Typography>
        </Container>
...
export default IndustryTagTooltipSection
