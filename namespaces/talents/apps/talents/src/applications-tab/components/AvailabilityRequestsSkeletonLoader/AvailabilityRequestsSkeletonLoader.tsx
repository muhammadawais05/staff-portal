...
const renderRow = (numberOfColumns: number) =>
  [...Array(numberOfColumns)].map((_, index) => (
    ...
    <Table.Cell key={index} css={S.cellWidth(index)}>
...
const AvailabilityRequestsSkeletonLoader = () => {
  return (
    <>
      <SkeletonLoader.Typography css={S.loaderStyle} />
      <Container top='small'>
        <Table>
...
export default AvailabilityRequestsSkeletonLoader
