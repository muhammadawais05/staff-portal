...
import { GET_TALENT_INFRACTIONS } from './get-talent-infractions.staff.gql'

export const createGetTalentInfractionsMock = (talentId: string) => ({
  request: {
    query: GET_TALENT_INFRACTIONS,
    variables: {
      talentId: talentId
    }
  },
