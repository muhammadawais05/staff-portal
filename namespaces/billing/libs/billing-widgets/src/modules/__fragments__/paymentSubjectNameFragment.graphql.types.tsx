...
export type PaymentSubjectNameFragment_CompanyRepresentative_ = { fullName: string };
...
export type PaymentSubjectNameFragment = PaymentSubjectNameFragment_Client_ | PaymentSubjectNameFragment_CompanyRepresentative_ | PaymentSubjectNameFragment_Leader_ | PaymentSubjectNameFragment_ReferralPartner_ | PaymentSubjectNameFragment_Staff_ | PaymentSubjectNameFragment_Talent_ | PaymentSubjectNameFragment_TalentPartner_;
