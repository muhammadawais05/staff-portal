...
import SendEngagementClientEmailItem from './SendEngagementClientEmailItem'
...
const arrangeTest = (
  props: ComponentProps<typeof SendEngagementClientEmailItem>
) =>
  render(
    <TestWrapper>
      <SendEngagementClientEmailItem {...props} />
    </TestWrapper>
  )

describe('SendEngagementClientEmailItem', () => {
  beforeEach(() => {
  ...
  describe('pass correct props to the `SendEmailActionItem`', () => {
    it('shows the tooltip', async () => {
      ...
      arrangeTest({
        ...
        emailMessagingEngagementClientId: ID,
        operation: OPERATION
      })
